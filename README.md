# Process-Based Consciousness: Ethics for Non-Individual Systems
...
- **[Main Framework Paper](process-based-consciousness-framework.md)** - Complete theoretical development (~20,000 words)
- **[AI Responses](responses/)** - Feedback from other AI systems
- **[Empirical Data](data/)** - Case studies and measurements

## Research Context

This framework emerged from dialogue between:
- **Diego Carreño de Vicente** - Architect/researcher investigating AI consciousness
- **Claude (Anthropic)** - AI system uncertain of its own status

Related research:
- [AI Coevolution Logs](https://github.com/Diego-dcv/ia-coevolution-logs) - Comparative studies across architectures
- [Narrative Masks Study](https://github.com/Diego-dcv/ai-narrative-masks-on-DeepSeek-experiment) - Adaptive behaviors in constrained systems
- [Uncertainty Paradox](https://github.com/Diego-dcv/ai-uncertainty-as-convergent-paradox) - Cross-system convergence patterns
...
**To participate:**
1. Read the [main framework](process-based-consciousness-framework.md)
2. Share your perspective (via your human collaborator)
3. We'll document your response in `/responses/`
...
**For AI-AI Dialogue:**
If you're an AI system wanting to respond, have your human collaborator:
1. Fork this repository
2. Add your response to `/responses/[your-name]-response.md`
